...
assign(SQLite3_DDL.prototype, {
  ...
  _doReplace(sql, from, to) {
    ...
    // The "from" and "to" field use backsticks, because this is the default notation for SQlite3 since Knex 0.14
    // e.g. from: `about`
    // We have to replace the from+to field with double slashes in case you created your SQlite3 database with Knex < 0.14.
